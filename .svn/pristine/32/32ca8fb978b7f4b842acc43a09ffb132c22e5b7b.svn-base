package view.bean.typeprelevement;
...
public class TypePrelevementBean {
    private RichPanelCollection collectionTypePrelevement;
    private RichPopup popupNew;
    final String OLD_CURR_KEY_VIEWSCOPE_ATTR = "__oldCurrentRowKey__";    ADFContext adfCtx = ADFContext.getCurrent();
    Map sessionScope = adfCtx.getSessionScope();
    Long utilisateur = Long.parseLong(sessionScope.get("id_user").toString());
    private RichPopup popupEdit;


    public TypePrelevementBean() {
    }

    public void setCollectionTypePrelevement(RichPanelCollection collectionTypePrelevement) {
        this.collectionTypePrelevement = collectionTypePrelevement;
    }

    public RichPanelCollection getCollectionTypePrelevement() {
        return collectionTypePrelevement;
    }
    ...
    public void onDialog(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            ...
            AdfFacesContext.getCurrentInstance().addPartialTarget(this.getCollectionTypePrelevement());
        }
    }
    ...
    public void onTypePrelevementDelete(DialogEvent dialogEvent) {
        // Add event code here...
        Outcome outcome = dialogEvent.getOutcome();
        if (outcome == Outcome.ok) {
            BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
    ...
    public void onDialogCancel(ClientEvent clientEvent) {
        ...
        popup.hide();
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("TypePrelevementIterator");
    ...
    public void onTypePrelevement(ActionEvent actionEvent) {
        // Add event code here...
        BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
