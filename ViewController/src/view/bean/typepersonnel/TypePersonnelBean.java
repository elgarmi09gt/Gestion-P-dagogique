package view.bean.typepersonnel;
...
public class TypePersonnelBean {
    private RichPanelCollection collectionTypePersonnel;
    ...
    public TypePersonnelBean() {
    }

    public void setCollectionTypePersonnel(RichPanelCollection collectionTypePersonnel) {
        this.collectionTypePersonnel = collectionTypePersonnel;
    }

    public RichPanelCollection getCollectionTypePersonnel() {
        return collectionTypePersonnel;
    }
    ...
    public void onDialog(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            ...
            AdfFacesContext.getCurrentInstance().addPartialTarget(this.getCollectionTypePersonnel());
        }
    }
    ...
    public void onDialogCancel(ClientEvent clientEvent) {
        ...
        popup.hide();
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("TypePersonnelIterator");
    ...
    public void onTypePersonnelDelete(DialogEvent dialogEvent) {
        // Add event code here...
        Outcome outcome = dialogEvent.getOutcome();
        if (outcome == Outcome.ok) {
            BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
    ...
    public void onTypePersonnel(ActionEvent actionEvent) {
        // Add event code here...
        BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
