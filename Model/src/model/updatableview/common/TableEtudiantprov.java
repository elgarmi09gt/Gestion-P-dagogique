...
// ---    Wed Oct 06 04:41:28 UTC 2021
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TableEtudiantprov extends Struct {
    ...
    public TableEtudiantprov(Datum value) throws SQLException {
        super(value);
    }

    public TableEtudiantprov() throws SQLException {
    }
        ...
        if (fac == null) {
            class facClass implements ORADataFactory {
                public ORAData create(Datum d, int sql_type_code) throws SQLException {
                    if (d != null) {
                        return new TableEtudiantprov(d);
                    }
                    return null;
                }
            }
    ...
    public String getColumnType() {
        return "TABLE_ETUDIANTPROV";
    }

    public Etudiantprov getetudiant() {
        return (Etudiantprov) getAttribute(0);
    }

    public void setetudiant(Etudiantprov value) {
    ...
    public void initStructureDef() {
        ...
        if (mStructureDef == null) {
            attrs[0] = new DomainAttributeDef("IdEtud", "IDETUD", 0, String.class, 12, "VARCHAR", -127, 255, false);
            attrs[1] = new DomainAttributeDef("Numero", "NUMERO", 1, String.class, 12, "VARCHAR", -127, 255, false);
            attrs[2] =
                new DomainAttributeDef("PrenomNom", "PRENOMNOM", 2, String.class, 12, "VARCHAR", -127, 255, false);
            attrs[3] =
                new DomainAttributeDef("DateNaiss", "DATENAISS", 3, String.class, 12, "VARCHAR", -127, 255, false);
            attrs[4] =
                new DomainAttributeDef("IdInscPed", "IDINSCPED", 4, String.class, 12, "VARCHAR", -127, 255, false);
