package view.beans.typecontrole;
...
public class TypeControleBean {
    ...
    public void setTypecontroleTable(RichTable typecontroleTable) {
        this.typecontroleTable = typecontroleTable;
    }

    public RichTable getTypecontroleTable() {
        return typecontroleTable;
    }
    ...
    public String OnNewClick() {
        ...
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("TypeControleIterator");
    ...
    public void OnDialogAction(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            ...
            AdfFacesContext.getCurrentInstance().addPartialTarget(this.getTypecontroleTable());
        }
    }
