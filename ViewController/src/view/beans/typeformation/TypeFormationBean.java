package view.beans.typeformation;
...
public class TypeFormationBean {
    ...
    private RichTable typeFormationTable;
    ...
    public TypeFormationBean() {
    }

    public void setTypeFormationTable(RichTable typeFormationTable) {
        this.typeFormationTable = typeFormationTable;
    }

    public RichTable getTypeFormationTable() {
        return typeFormationTable;
    }
    ...
    public void OnDialogAction(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            ...
            AdfFacesContext.getCurrentInstance().addPartialTarget(this.getTypeFormationTable());
        }
    }
    ...
    public void OnDialogCancel(ClientEvent clientEvent) {
        ...
        //iterator
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("TypeFormationIterator");
