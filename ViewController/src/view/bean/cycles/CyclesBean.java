...
public class CyclesBean {
    ...
    private RichPanelCollection collectionCycles;
    ...
    public void onDialogNew(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            ...
            AdfFacesContext.getCurrentInstance().addPartialTarget(this.getCollectionCycles());
        }
    }
    ...
    public void onDialogCancel(ClientEvent clientEvent) {
        ...
        popup.hide();
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("CyclesIterator");
    ...
    public void setCollectionCycles(RichPanelCollection collectionCycles) {
        this.collectionCycles = collectionCycles;
    }

    public RichPanelCollection getCollectionCycles() {
        return collectionCycles;
    }

    public void onCyclesDelete(DialogEvent dialogEvent) {
        // Add event code here...
        Outcome outcome = dialogEvent.getOutcome();
        if (outcome == Outcome.ok) {
            BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
    ...
    public void onCycles(ActionEvent actionEvent) {
        // Add event code here...
        BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
    ...
    public void onDialogEdit(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            //commit
            BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
            AttributeBinding utimodif = (AttributeBinding) bindings.getControlBinding("UtiModifie");
