...
public class CivilitesBean {
    ...
    public void OnDialogAction(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            ...
            AdfFacesContext.getCurrentInstance().addPartialTarget(this.getCivilitesTable());
        }
    }
    ...
    public void setCivilitesTable(RichTable civilitesTable) {
        this.civilitesTable = civilitesTable;
    }

    public RichTable getCivilitesTable() {
        return civilitesTable;
    }
    ...
    public String OnNewClick() {
        ...
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("CivilitesIterator");
