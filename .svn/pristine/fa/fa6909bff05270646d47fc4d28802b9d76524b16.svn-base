package view.bean.anneesunivers;
...
public class AnneesUniversBean {
    private RichPanelCollection collectionAnneesUnivers;
    ...
    public void setCollectionAnneesUnivers(RichPanelCollection collectionAnneesUnivers) {
        this.collectionAnneesUnivers = collectionAnneesUnivers;
    }

    public RichPanelCollection getCollectionAnneesUnivers() {
        return collectionAnneesUnivers;
    }
    ...
    public void onDialogCancel(ClientEvent clientEvent) {
        ...
        popup.hide();
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("AnneesUniversIterator");
        ...
        AdfFacesContext.getCurrentInstance().addPartialTarget(this.getCollectionAnneesUnivers());
    ...
    public void onAnneeUniversDelete(DialogEvent dialogEvent) {
        // Add event code here...
        Outcome outcome = dialogEvent.getOutcome();
        if (outcome == Outcome.ok) {
            BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
    ...
    public void onAnneesUnivers(ActionEvent actionEvent) {
        // Add event code here...
        BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
