...
public class DecaisserDepartBean {
    ...
    public void onRechercheCompte(ActionEvent actionEvent) {
        // Add event code here...
        OperationBinding op_les_cmpt = getBindings().getOperationBinding("getCompteDeptDec");
    ...
    public void onInsertBen(ActionEvent actionEvent) {
        ...
        DCIteratorBinding iter_op_cmpt_dept = (DCIteratorBinding) BindingContext.getCurrent().getCurrentBindingsEntry().get("CompteDeptDecaisseRechROIterator");
    ...
    public void onDialogConfOper(DialogEvent dialogEvent) {
        ...
        Integer res_op = insertOperation(sessionScope.get("montant_var").toString(), "2", id_mode_paie.getInputValue().toString(), row_op_cmpt_dept.getAttribute("IdCompte").toString(), getNum_chq_vir(), getBanque(),  getObjet(), "0", sessionScope.get("num_op_var").toString(), "0",sessionScope.get("num_ben_op_var").toString(),getDate_op(),"1"); 
