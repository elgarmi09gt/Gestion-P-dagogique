package view.beans.zonegeographiques;
...
public class ZoneGeographiqueBean {
    final String OLD_CURR_KEY_VIEWSCOPE_ATTR = "__oldCurrentRowKey__";
    private RichTable zoneGeographiqueTable;
    ...
    public ZoneGeographiqueBean() {
    }

    public void setZoneGeographiqueTable(RichTable zoneGeographiqueTable) {
        this.zoneGeographiqueTable = zoneGeographiqueTable;
    }

    public RichTable getZoneGeographiqueTable() {
        return zoneGeographiqueTable;
    }
    ...
    public void OnDialogAction(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            ...
            AdfFacesContext.getCurrentInstance().addPartialTarget(this.getZoneGeographiqueTable());
        }
    }
