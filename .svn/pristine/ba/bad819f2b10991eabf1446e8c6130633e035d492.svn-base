...
// ---    Tue Sep 01 14:47:20 GMT 2020
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class ScolRefonteNoteec implements DomainInterface, Serializable {
    public ScolRefonteNoteec(String val) {
        mData = new String(val);
        validate();
    }
    private String mData;

    protected ScolRefonteNoteec() {
        mData = "";
    }
