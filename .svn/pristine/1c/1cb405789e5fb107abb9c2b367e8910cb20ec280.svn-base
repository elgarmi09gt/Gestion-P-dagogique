...
// ---    Wed Jun 23 12:48:43 UTC 2021
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class ScolRefonteNoteec4 implements DomainInterface, Serializable {
    public ScolRefonteNoteec4(String val) {
        mData = new String(val);
        validate();
    }
    private String mData;

    protected ScolRefonteNoteec4() {
        mData = "";
    }
