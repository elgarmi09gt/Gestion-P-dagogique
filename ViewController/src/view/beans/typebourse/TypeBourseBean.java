...
public class TypeBourseBean {
    final String OLD_CURR_KEY_VIEWSCOPE_ATTR = "__oldCurrentRowKey__";
    private RichTable typeBourseTable;
    ...
    public TypeBourseBean() {
    }

    public void setTypeBourseTable(RichTable typeBourseTable) {
        this.typeBourseTable = typeBourseTable;
    }

    public RichTable getTypeBourseTable() {
        return typeBourseTable;
    }
    ...
    public void OnDialogAction(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            ...
            AdfFacesContext.getCurrentInstance().addPartialTarget(this.getTypeBourseTable());
        }
    }
    ...
    public void OnDialogCancel(ClientEvent clientEvent) {
        ...
        //iterator
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("TypeBoursesIterator");
