...
public class CohortesBean {
    private RichPanelCollection cohortesCollection;
    ...
    public void setCohortesCollection(RichPanelCollection cohortesCollection) {
        this.cohortesCollection = cohortesCollection;
    }

    public RichPanelCollection getCohortesCollection() {
        return cohortesCollection;
    }
    ...
    public void onDialogNew(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            ...
            AdfFacesContext.getCurrentInstance().addPartialTarget(this.getCohortesCollection());
        }
    }
    ...
    public void onDialogCancel(ClientEvent clientEvent) {
        ...
        popup.hide();
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("CohortesIterator");
    ...
    public void onCohortesDelete(DialogEvent dialogEvent) {
        // Add event code here...
        Outcome outcome = dialogEvent.getOutcome();
        if (outcome == Outcome.ok) {
            BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
    ...
    public void onCohortes(ActionEvent actionEvent) {
        // Add event code here...
        BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
