...
public class SemestresBean {
    private RichPanelCollection collectionSemestres;
    ...
    public SemestresBean() {
    }

    public void setCollectionSemestres(RichPanelCollection collectionSemestres) {
        this.collectionSemestres = collectionSemestres;
    }

    public RichPanelCollection getCollectionSemestres() {
        return collectionSemestres;
    }
    ...
    public void onDialogCancel(ClientEvent clientEvent) {
        ...
        popup.hide();
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("SemestresIterator");
        ...
        AdfFacesContext.getCurrentInstance().addPartialTarget(this.getCollectionSemestres());
    ...
    public void onSemestresDelete(DialogEvent dialogEvent) {
        // Add event code here...
        Outcome outcome = dialogEvent.getOutcome();
        if (outcome == Outcome.ok) {
            BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
    ...
    public void onSemestres(ActionEvent actionEvent) {
        // Add event code here...
        BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
