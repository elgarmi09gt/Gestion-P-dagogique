...
public class OrganismesBean {
    final String OLD_CURR_KEY_VIEWSCOPE_ATTR = "__oldCurrentRowKey__";
    private RichTable organismesTable;
    ...
    public OrganismesBean() {
    }

    public void setOrganismesTable(RichTable organismesTable) {
        this.organismesTable = organismesTable;
    }

    public RichTable getOrganismesTable() {
        return organismesTable;
    }
    ...
    public void OnNewClick(ActionEvent actionEvent) {
        ...
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("OrganismesIterator");
    ...
    public void OnDialogAction(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            ...
            AdfFacesContext.getCurrentInstance().addPartialTarget(this.getOrganismesTable());
        }
    }
