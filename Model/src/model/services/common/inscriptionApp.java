...
public interface inscriptionApp extends ApplicationModule {
    ...
    void findAndUpdateInsPed(Long id_ins_ped, Long etat);

    void UpdateEtatInsc(Long id_ins_ped, Long etat);

    void findAndUpdateSusp(Long id_susp, Long levee, Long util);

    void UpdateSuspension(Long id_susp, Long levee, Long util);
