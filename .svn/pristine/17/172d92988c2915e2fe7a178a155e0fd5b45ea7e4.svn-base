package view.beans.modecontrole;
...
public class ModeControleBean {
    final String OLD_CURR_KEY_VIEWSCOPE_ATTR = "__oldCurrentRowKey__";
    private RichTable modeControleTable;
    ...
    public ModeControleBean() {
    }

    public void setModeControleTable(RichTable modeControleTable) {
        this.modeControleTable = modeControleTable;
    }

    public RichTable getModeControleTable() {
        return modeControleTable;
    }
    ...
    public void OnDialogAction(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            ...
            AdfFacesContext.getCurrentInstance().addPartialTarget(this.getModeControleTable());
        }
    }
    ...
    public void OnDialogCancel(ClientEvent clientEvent) {
        ...
        //iterator
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("ModeControleIterator");
