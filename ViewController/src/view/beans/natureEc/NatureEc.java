...
public class NatureEc {
    final String OLD_CURR_KEY_VIEWSCOPE_ATTR = "__oldCurrentRowKey__";
    private RichPopup popupNew;
    private RichTable natureEcTable;
    ...
    public String OnNewClick() {
        ...
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("NatureEcIterator");
    ...
    public void setNatureEcTable(RichTable natureEcTable) {
        this.natureEcTable = natureEcTable;
    }

    public RichTable getNatureEcTable() {
        return natureEcTable;
    }
    ...
    public void OnDialogAction(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            ...
            AdfFacesContext.getCurrentInstance().addPartialTarget(this.getNatureEcTable());
        }
    }
