...
// ---    Fri May 28 17:04:47 UTC 2021
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class ScolRefonteNoteec1 implements DomainInterface, Serializable {
    public ScolRefonteNoteec1(String val) {
        mData = new String(val);
        validate();
    }
    private String mData;

    protected ScolRefonteNoteec1() {
        mData = "";
    }
