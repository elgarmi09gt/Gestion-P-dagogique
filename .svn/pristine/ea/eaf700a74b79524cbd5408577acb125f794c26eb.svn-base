...
// ---    Mon Jun 21 13:16:38 UTC 2021
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class ScolRefonteNoteec3 implements DomainInterface, Serializable {
    public ScolRefonteNoteec3(String val) {
        mData = new String(val);
        validate();
    }
    private String mData;

    protected ScolRefonteNoteec3() {
        mData = "";
    }
