...
public class NouvBacBean {
    private RichPopup popEtud;
    ...
    public void setPopEtud(RichPopup popEtud) {
        this.popEtud = popEtud;
    }

    public RichPopup getPopEtud() {
        return popEtud;
    }
    ...
    public void onDialogCan(ClientEvent clientEvent) {
        // Add event code here...
        RichPopup popup = this.getPopEtud();
        popup.hide();
        DCIteratorBinding dciter = (DCIteratorBinding) getBindings().get("NouveauxBacheliersIterator");
    ...
    public void onDialog(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {        // commit
            ...
            if (!operationBinding.getErrors().isEmpty()) {
                ...
                FacesMessage msg = new FacesMessage("La personne du prenom & nom : "+prenom_bd+" "+nom_bd+" est enregistrée comme Nouveau Bachelier");
            ...
            this.getPopEtud().hide();
        }
    }

    public String onRechercheNouvBac() {
        // Add event code here...
        
        inscriptionAppImpl am = (inscriptionAppImpl)resolvElDC("inscriptionAppDataControl");
        ViewObject liste_persVo = am.getPersNouvBachelierRO();
        
        ViewCriteriaManager vcm = liste_persVo.getViewCriteriaManager();
        ViewCriteria vc = vcm.getViewCriteria("PersNouvBachelierROVOCriteria");
    ...
    public String onAddNouvBac() {
        // Add event code here...
        
        ADFContext adfCtx = ADFContext.getCurrent();
        Map sessionScope = adfCtx.getSessionScope();
        BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
        DCIteratorBinding iter_pers = (DCIteratorBinding) bindings.get("PersNouvBachelierROIterator");
        ...
        AttributeBinding id_pers = (AttributeBinding) getBindings().getControlBinding("IdPersonne1");
        ...
        if (!operationBinding.getErrors().isEmpty()) {
            ...
            id_annee.setInputValue(Long.parseLong(sessionScope.get("id_annee").toString()));
