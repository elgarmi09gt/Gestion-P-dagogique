...
public class PrintAttestationsBean {
    public PrintAttestationsBean() {
    }
    ...
    public void OnPrintAttestationClicked(ActionEvent actionEvent) {
        ...
        if(currentetu == null) {
            System.out.println("Pas d'attestation pour ce parcours !!!");
        }else{
            Long pcrs = Long.parseLong(currentetu.getAttribute("IdNiveauFormationParcours").toString()) ;
            Long an = new Long(2) ;
            //String etu =currentetu.getAttribute("Numero").toString() ;
            Long hs = new Long(5) ;
