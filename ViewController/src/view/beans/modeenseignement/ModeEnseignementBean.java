package view.beans.modeenseignement;
...
public class ModeEnseignementBean {
    final String OLD_CURR_KEY_VIEWSCOPE_ATTR = "__oldCurrentRowKey__";
    private RichTable modeEnseignementTable;
    ...
    public ModeEnseignementBean() {
    }

    public void setModeEnseignementTable(RichTable modeEnseignementTable) {
        this.modeEnseignementTable = modeEnseignementTable;
    }

    public RichTable getModeEnseignementTable() {
        return modeEnseignementTable;
    }
    ...
    public void OnDialogAction(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            ...
            AdfFacesContext.getCurrentInstance().addPartialTarget(this.getModeEnseignementTable());
        }
    }
    ...
    public String OnNewClick() {
        ...
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("ModeEnseignementIterator");
