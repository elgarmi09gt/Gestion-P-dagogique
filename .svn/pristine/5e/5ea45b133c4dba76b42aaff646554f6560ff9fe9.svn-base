...
public class SessionsBean {
    private RichPanelCollection collectionSessions;
    ...
    public void setCollectionSessions(RichPanelCollection collectionSessions) {
        this.collectionSessions = collectionSessions;
    }

    public RichPanelCollection getCollectionSessions() {
    ...
    public void onDialogNew(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            ...
            AdfFacesContext.getCurrentInstance().addPartialTarget(this.getCollectionSessions());
        }
    }
    ...
    public void onDialogCancel(ClientEvent clientEvent) {
        ...
        popup.hide();
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("SessionsIterator");
    ...
    public void onSessionsDelete(DialogEvent dialogEvent) {
        // Add event code here...
        Outcome outcome = dialogEvent.getOutcome();
        if (outcome == Outcome.ok) {
            BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
    ...
    public void onSessions(ActionEvent actionEvent) {
        // Add event code here...
        BindingContainer bindings = BindingContext.getCurrent().getCurrentBindingsEntry();
