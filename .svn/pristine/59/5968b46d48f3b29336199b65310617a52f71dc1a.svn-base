...
public class TypeNoteBean {
    final String OLD_CURR_KEY_VIEWSCOPE_ATTR = "__oldCurrentRowKey__";
    private RichTable typeNoteTable;
    private RichPopup popubNew;
    ...
    public void setTypeNoteTable(RichTable typeNoteTable) {
        this.typeNoteTable = typeNoteTable;
    }

    public RichTable getTypeNoteTable() {
        return typeNoteTable;
    }

    public void setPopubNew(RichPopup popubNew) {
        this.popubNew = popubNew;
    }

    public RichPopup getPopubNew() {
        return popubNew;
    }
    ...
    public void OnDialogAction(DialogEvent dialogEvent) {
        ...
        if (outcome == Outcome.ok) {
            ...
            this.getPopubNew().hide();
            AdfFacesContext.getCurrentInstance().addPartialTarget(this.getTypeNoteTable());
        }
    }
    ...
    public String OnNewClick() {
        ...
        DCIteratorBinding dciter = (DCIteratorBinding) bindings.get("TypeNoteIterator");
        ...
        RichPopup popup = this.getPopubNew();
    ...
    public void OnEditClick(ActionEvent actionEvent) {
        // Add event code here...
        AttributeBinding utimd = (AttributeBinding) getBindings().getControlBinding("UtiModifie");
        utimd.setInputValue(getUtilisateur());
